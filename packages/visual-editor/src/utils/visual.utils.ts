...
export const createVisualBlock = (visualComponent: VisualEditorComponent): VisualBlockData => {
  ...
  return {
    ...
    souceDataType:
      component.souceDataType ||
      (component.key === 'VisualObject' || component.key === 'VisualObjectArray' ? component.key : undefined),
  }
}
...
export const formatVisualBlockData = (block: Partial<VisualBlockData>): VisualBlockData => {
  ...
  return {
    ...
    souceDataType:
      block.souceDataType ||
      (block.key === 'VisualObject' || block.key === 'VisualObjectArray' ? block.key : undefined),
  }
}
