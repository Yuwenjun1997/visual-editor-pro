<template>
  <div class="visual-business-data">
    <template v-if="provider">
      <el-form label-position="top" size="small">
        ...
        <el-form-item>
          ...
          <span class="ve-ml-2 ve-text-xs" style="color: #909399">
      ...
      >
        <div style="color: #67c23a; font-size: 12px">
          已绑定:{{
            modelValue.businessDataRef.businessType === 'products'
              ? '商品'
              : '文章'
          }}
          &nbsp;·&nbsp;{{
            modelValue.businessDataRef.refType === 'all'
              ? '全部分类'
              : '分类数据'
          }}
        </div>
    ...
    <el-empty v-else description="未配置数据服务" :image-size="60" />
  </div>
</template>

<script setup lang="ts">
import type {
  VisualBusinessDataRef,
  VisualSourceOptions,
} from '@visual/ui/types'
