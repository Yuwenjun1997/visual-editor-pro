<template>
  <el-dropdown class="visual-avatar" @command="handleCommand">
    <div class="ve-flex ve-items-center ve-outline-none">
      <el-avatar :size="30" :src="avatarUrl" />
      <span class="ve-mx-1 ve-whitespace-nowrap">用户名</span>
